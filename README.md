...
- Local TXT, sanitized HTML, lightweight paginated PDF with page-range export, simple table boxes, and image figure placeholders, plus minimal DOCX export-to-path workflows and a WebView print flow using sanitized print HTML.
