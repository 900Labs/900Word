...
- `.odt`: MVP read/write boundary for generated documents, covering paragraphs, headings, inline marks, safe links, lists, tables, page breaks, metadata title, named paragraph styles, basic page setup, 900Word-authored direct paragraph/text formatting, and allowlisted embedded image bytes.
